        ...
        <div class="help-modal-content">
            ...
            <div class="help-modal-body">
                <div class="help-section">
                    ...
                    <ul>
                        <li><a href="/Gestion-sena/dashboard_sena/_docs/INSTRUCCIONES_USUARIO.md" target="_blank">Manual de Usuario</a></li>
                        <li><a href="/Gestion-sena/dashboard_sena/_docs/ARQUITECTURA_DASHBOARD.md" target="_blank">Arquitectura del Sistema</a></li>
                        <li><a href="/Gestion-sena/dashboard_sena/_docs/SISTEMA_ROUTING.md" target="_blank">Sistema de Routing</a></li>
                    </ul>
                </div>
