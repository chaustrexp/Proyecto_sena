<?php
// Vista de crear instru_competencia
// Los datos vienen del controlador: $pageTitle, $instructores, $competenciasPorPrograma
?>
    ...
    <div style="max-width: 700px; margin: 0 auto; padding: 32px;">
        <div style="background: white; border-radius: 12px; border: 1px solid #e5e7eb; padding: 32px;">
            <div style="margin-bottom: 32px; padding-bottom: 24px; border-bottom: 1px solid #e5e7eb;">
                <a href="/Gestion-sena/dashboard_sena/instru_competencia/index" style="display: inline-flex; align-items: center; gap: 8px; color: #6b7280; text-decoration: none; margin-bottom: 16px; font-size: 14px;">
            ...
            <form method="POST" action="/Gestion-sena/dashboard_sena/instru_competencia/crear" id="formCrear">
                ...
                <div style="display: flex; gap: 12px; justify-content: flex-end; margin-top: 32px; padding-top: 24px; border-top: 1px solid #e5e7eb;">
                    <a href="/Gestion-sena/dashboard_sena/instru_competencia/index" class="btn btn-secondary">Cancelar</a>
