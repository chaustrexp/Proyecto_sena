...
<div class="main-content">
    ...
    <div style="padding: 32px 32px 24px; display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid #e5e7eb;">
        ...
        <a href="/Gestion-sena/dashboard_sena/instru_competencia/crear" class="btn btn-primary" style="display: inline-flex; align-items: center; gap: 8px;">
    ...
    <?php if (empty($competenciasPorPrograma ?? [])): ?>
        <div style="margin: 24px 32px; padding: 16px; background: #FEF3C7; border-left: 4px solid #F59E0B; border-radius: 8px; color: #92400E;">
            ...
            <a href="/Gestion-sena/dashboard_sena/competencia_programa/index" style="color: #39A900; font-weight: 600;">Competencias por Programa</a>.
        </div>
    <?php endif; ?>
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="6" style="text-align: center; padding: 60px 20px; color: #6b7280;">
                            ...
                            <a href="/Gestion-sena/dashboard_sena/instru_competencia/crear" class="btn btn-primary btn-sm">Crear Primera Asignación</a>
                        </td>
                    </tr>
                    <?php else: ?>
                        ...
                        <tr style="border-bottom: 1px solid #f3f4f6;">
                            ...
                            <td style="padding: 16px;">
                                <div class="btn-group" style="justify-content: flex-end;">
                                    <a href="/Gestion-sena/dashboard_sena/instru_competencia/ver?id=<?php echo $registro['inscomp_id']; ?>" class="btn btn-secondary btn-sm">Ver</a>
                                    <a href="/Gestion-sena/dashboard_sena/instru_competencia/editar?id=<?php echo $registro['inscomp_id']; ?>" class="btn btn-primary btn-sm">Editar</a>
...
<script>
    ...
    function confirmarEliminacion(id) {
        if (confirm('¿Está seguro de eliminar esta asignación de competencia?')) {
            window.location.href = `/Gestion-sena/dashboard_sena/instru_competencia/eliminar?id=${id}`;
        }
    }
</script>
