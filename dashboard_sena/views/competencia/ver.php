...
<div class="main-content">
    <div style="padding: 32px 32px 24px; border-bottom: 1px solid #e5e7eb;">
        <a href="/Gestion-sena/dashboard_sena/competencia/index" style="display: inline-flex; align-items: center; gap: 8px; color: #6b7280; text-decoration: none; margin-bottom: 16px; font-size: 14px;">
        ...
        <div style="display: flex; justify-content: space-between; align-items: start;">
            ...
            <a href="/Gestion-sena/dashboard_sena/competencia/editar/<?php echo htmlspecialchars($registro['comp_id'] ?? ''); ?>" class="btn btn-primary">Editar</a>
        </div>
    </div>
    ...
    <div style="max-width: 900px; margin: 0 auto; padding: 32px;">
        <div style="background: white; border-radius: 12px; border: 1px solid #e5e7eb; padding: 32px;">
            ...
            <div style="display: flex; gap: 12px; justify-content: flex-end; padding-top: 24px; border-top: 1px solid #e5e7eb;">
                <a href="/Gestion-sena/dashboard_sena/competencia/index" class="btn btn-secondary">Volver</a>
                <a href="/Gestion-sena/dashboard_sena/competencia/editar/<?php echo htmlspecialchars($registro['comp_id'] ?? ''); ?>" class="btn btn-primary">Editar Competencia</a>
            </div>
        </div>
    </div>
</div>
