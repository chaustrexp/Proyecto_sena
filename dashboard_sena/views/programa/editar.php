    ...
    <div style="max-width: 700px; margin: 0 auto; padding: 32px;">
        <div style="background: white; border-radius: 12px; border: 1px solid #e5e7eb; padding: 32px;">
            ...
            <div style="margin-bottom: 32px; padding-bottom: 24px; border-bottom: 1px solid #e5e7eb;">
                <a href="/Gestion-sena/dashboard_sena/programa/index" style="display: inline-flex; align-items: center; gap: 8px; color: #6b7280; text-decoration: none; margin-bottom: 16px; font-size: 14px;">
            ...
            <form method="POST" action="/Gestion-sena/dashboard_sena/programa/edit/<?php echo htmlspecialchars($registro['prog_codigo'] ?? ''); ?>">
                ...
                <div class="form-group">
                    ...
                    <select name="tipo" class="form-control" required style="width: 100%; padding: 12px; border: 1px solid #e5e7eb; border-radius: 8px; font-size: 14px;">
                ...
                <div class="form-group">
                    ...
                    <select name="titulo_id" class="form-control" required style="width: 100%; padding: 12px; border: 1px solid #e5e7eb; border-radius: 8px; font-size: 14px;">
                        <option value="">Seleccione...</option>
                        <?php if (isset($titulos) && is_array($titulos)): ?>
                            <?php foreach ($titulos as $titulo): ?>
                                <option value="<?php echo htmlspecialchars($titulo['titpro_id'] ?? ''); ?>" 
                                        <?php echo (($registro['TIT_PROGRAMA_titpro_id'] ?? '') == ($titulo['titpro_id'] ?? '')) ? 'selected' : ''; ?>>
