    ...
    <?php if (registroValido($registro)): ?>
        ...
        <div style="padding: 32px 32px 24px; border-bottom: 1px solid #e5e7eb;">
            ...
            <div style="display: flex; justify-content: space-between; align-items: start;">
                <div>
                    <h1 style="font-size: 28px; font-weight: 700; color: #1f2937; margin: 0 0 4px;"><?php echo safeHtml($registro, 'prog_denominacion'); ?></h1>
                    <p style="font-size: 14px; color: #6b7280; margin: 0;">Código: <strong style="color: #39A900;"><?php echo safeHtml($registro, 'prog_codigo'); ?></strong></p>
                </div>
                <a href="editar.php?id=<?php echo safeHtml($registro, 'prog_codigo'); ?>" class="btn btn-primary">Editar</a>
            </div>
        </div>
            ...
            <div style="background: white; border-radius: 12px; border: 1px solid #e5e7eb; padding: 32px;">
                ...
                <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 24px; margin-bottom: 24px;">
                    ...
                    <div>
                        ...
                        <div style="font-size: 18px; font-weight: 700; color: #39A900;"><?php echo safeHtml($registro, 'prog_codigo'); ?></div>
                    </div>

                    <div>
                        <div style="font-size: 12px; color: #6b7280; margin-bottom: 4px; text-transform: uppercase; font-weight: 600;">Tipo</div>
                        <div style="font-size: 18px; font-weight: 700; color: #1f2937;"><?php echo safeHtml($registro, 'prog_tipo'); ?></div>
                    </div>
                    ...
                    <div style="grid-column: 1 / -1;">
                        ...
                        <div style="font-size: 18px; font-weight: 600; color: #1f2937;"><?php echo safeHtml($registro, 'prog_denominacion'); ?></div>
                    </div>
                    ...
                    <div style="grid-column: 1 / -1;">
                        ...
                        <div style="font-size: 16px; font-weight: 600; color: #1f2937;">
                            <span style="background: #E8F5E8; color: #39A900; padding: 6px 12px; border-radius: 12px; font-size: 14px;">
                                <?php echo safeHtml($registro, 'titpro_nombre', 'Sin título'); ?>
                            </span>
                        </div>
                    </div>
                ...
                <div style="display: flex; gap: 12px; justify-content: flex-end; padding-top: 24px; border-top: 1px solid #e5e7eb;">
                    ...
                    <a href="editar.php?id=<?php echo safeHtml($registro, 'prog_codigo'); ?>" class="btn btn-primary">Editar Programa</a>
                </div>
            </div>
        </div>
    <?php else: ?>
        <div style="padding: 32px;">
            ...
            <p style="padding: 20px; text-align: center; color: #666;">No se encontró el programa solicitado.</p>
