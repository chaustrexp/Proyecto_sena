...
<div class="main-content">
    ...
    <div style="padding: 32px 32px 24px; border-bottom: 1px solid #e5e7eb;">
        ...
        <div style="display: flex; justify-content: space-between; align-items: start;">
            ...
            <a href="/Gestion-sena/dashboard_sena/programa/edit/<?php echo htmlspecialchars($registro['prog_codigo'] ?? ''); ?>" class="btn btn-primary">Editar</a>
        </div>
    </div>
    ...
    <div style="max-width: 800px; margin: 0 auto; padding: 32px;">
        <div style="background: white; border-radius: 12px; border: 1px solid #e5e7eb; padding: 32px;">
            ...
            <div style="display: flex; gap: 12px; justify-content: flex-end; padding-top: 24px; border-top: 1px solid #e5e7eb;">
                <a href="/Gestion-sena/dashboard_sena/programa/index" class="btn btn-secondary">Volver</a>
                <a href="/Gestion-sena/dashboard_sena/programa/edit/<?php echo htmlspecialchars($registro['prog_codigo'] ?? ''); ?>" class="btn btn-primary">Editar Programa</a>
            </div>
        </div>
    </div>
</div>
