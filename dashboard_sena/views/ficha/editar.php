...
<div class="main-content">
    <div class="form-container">
        ...
        <form method="POST" action="/Gestion-sena/dashboard_sena/ficha/edit/<?php echo htmlspecialchars($registro['fich_id'] ?? ''); ?>">
            ...
            <div class="btn-group">
                ...
                <a href="/Gestion-sena/dashboard_sena/ficha/index" class="btn btn-secondary">
