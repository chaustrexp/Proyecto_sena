...
<div class="main-content">
    ...
    <div style="padding: 32px 32px 24px; border-bottom: 1px solid #e5e7eb;">
        <a href="/Gestion-sena/dashboard_sena/ficha/index" style="display: inline-flex; align-items: center; gap: 8px; color: #6b7280; text-decoration: none; margin-bottom: 16px; font-size: 14px;">
        ...
        <div style="display: flex; justify-content: space-between; align-items: start;">
            ...
            <a href="/Gestion-sena/dashboard_sena/ficha/edit/<?php echo htmlspecialchars($registro['fich_id'] ?? ''); ?>" class="btn btn-primary">Editar</a>
        </div>
    </div>
        ...
        <div style="background: white; border-radius: 12px; border: 1px solid #e5e7eb; padding: 32px;">
            ...
            <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 24px;">
                ...
                <div style="grid-column: 1 / -1;">
                    ...
                    <div style="font-size: 16px; font-weight: 600; color: #1f2937;">
                        <?php echo htmlspecialchars($registro['coord_descripcion'] ?? 'Sin coordinación'); ?>
                    </div>
                </div>
            ...
            <div style="display: flex; gap: 12px; justify-content: flex-end; padding-top: 24px; border-top: 1px solid #e5e7eb; margin-top: 24px;">
                <a href="/Gestion-sena/dashboard_sena/ficha/index" class="btn btn-secondary">Volver</a>
                <a href="/Gestion-sena/dashboard_sena/ficha/edit/<?php echo htmlspecialchars($registro['fich_id'] ?? ''); ?>" class="btn btn-primary">Editar Ficha</a>
            </div>
        </div>
    </div>
</div>
