...
<div class="main-content">
    <div style="max-width: 800px; margin: 0 auto; padding: 32px;">
        ...
        <div style="margin-bottom: 32px; display: flex; justify-content: space-between; align-items: center;">
            ...
            <a href="/Gestion-sena/dashboard_sena/coordinacion/editar/<?php echo $registro['coord_id']; ?>" class="btn btn-primary">
        ...
        <div style="background: white; border-radius: 12px; border: 1px solid #e5e7eb; overflow: hidden;">
            ...
            <div style="background: linear-gradient(135deg, #a855f7 0%, #9333ea 100%); padding: 24px; color: white;">
                <div style="display: flex; align-items: center; gap: 16px;">
                    ...
                    <div>
                        <h2 style="font-size: 24px; font-weight: 700; margin: 0 0 4px;"><?php echo htmlspecialchars($registro['coord_descripcion']); ?></h2>
                ...
                <div style="display: grid; gap: 24px;">
                    ...
                    <div style="border-bottom: 1px solid #f3f4f6; padding-bottom: 16px;">
                        ...
                        <div style="font-size: 16px; color: #1f2937;">
                            <?php echo htmlspecialchars($registro['coord_descripcion']); ?>
                        </div>
                    </div>
                    ...
                    <div style="border-bottom: 1px solid #f3f4f6; padding-bottom: 16px;">
                        ...
                        <div style="font-size: 16px; color: #1f2937;">
                            <a href="mailto:<?php echo htmlspecialchars($registro['coord_correo']); ?>" style="color: #a855f7; text-decoration: none;">
                                <?php echo htmlspecialchars($registro['coord_correo']); ?>
                            </a>
                        </div>
                    </div>
                </div>
