...
<div class="main-content">
    <div style="max-width: 700px; margin: 0 auto; padding: 32px;">
        <div style="background: white; border-radius: 12px; border: 1px solid #e5e7eb; padding: 32px;">
            ...
            <form method="POST" action="/Gestion-sena/dashboard_sena/titulo_programa/editar?id=<?php echo htmlspecialchars($registro['titpro_id'] ?? ''); ?>">
                ...
                <div style="display: flex; gap: 12px; justify-content: flex-end; margin-top: 32px; padding-top: 24px; border-top: 1px solid #e5e7eb;">
                    <a href="/Gestion-sena/dashboard_sena/titulo_programa/index" class="btn btn-secondary">Cancelar</a>
