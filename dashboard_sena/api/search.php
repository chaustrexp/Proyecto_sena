...
try {
    ...
    while ($row = $result->fetch_assoc()) {
        $results[] = [
            ...
            'url' => '/Gestion-sena/dashboard_sena/views/instructor/ver.php?id=' . $row['id'],
            'icon' => 'user',
            'type' => 'instructor'
        ];
    }
    ...
    while ($row = $result->fetch_assoc()) {
        $results[] = [
            ...
            'url' => '/Gestion-sena/dashboard_sena/views/ficha/ver.php?id=' . $row['id'],
            'icon' => 'file-text',
            'type' => 'ficha'
        ];
    }
    ...
    while ($row = $result->fetch_assoc()) {
        $results[] = [
            ...
            'url' => '/Gestion-sena/dashboard_sena/views/programa/ver.php?id=' . $row['id'],
            'icon' => 'book-open',
            'type' => 'programa'
        ];
    }
    ...
    while ($row = $result->fetch_assoc()) {
        $results[] = [
            ...
            'url' => '/Gestion-sena/dashboard_sena/views/ambiente/ver.php?id=' . $row['id'],
            'icon' => 'map-pin',
            'type' => 'ambiente'
        ];
    }
    ...
    while ($row = $result->fetch_assoc()) {
        $results[] = [
            ...
            'url' => '/Gestion-sena/dashboard_sena/views/asignacion/ver.php?id=' . $row['id'],
            'icon' => 'calendar',
            'type' => 'asignacion'
        ];
    }
