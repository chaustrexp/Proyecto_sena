...
class CentroFormacionController extends BaseController {
    ...
    public function store() {
        if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
            $this->redirect('/Gestion-sena/dashboard_sena/centro_formacion');
            return;
        }
        ...
        if (!empty($errors)) {
            ...
            $this->redirect('/Gestion-sena/dashboard_sena/centro_formacion/crear');
            return;
        }
    ...
    public function update($id) {
        ...
        if (!empty($errors)) {
            $_SESSION['error'] = 'Por favor complete todos los campos requeridos';
            $this->redirect('/Gestion-sena/dashboard_sena/centro_formacion/editar/' . $id);
            return;
        }
