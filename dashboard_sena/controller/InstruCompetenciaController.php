...
class InstruCompetenciaController extends BaseController {
    ...
    public function store() {
        ...
        if (!empty($errors)) {
            ...
            $this->redirect('/Gestion-sena/dashboard_sena/instru_competencia/crear');
        }
        ...
        try {
            ...
            $this->redirect('/Gestion-sena/dashboard_sena/instru_competencia');
        } catch (Exception $e) {
    ...
    public function update($id) {
        ...
        if (!empty($errors)) {
            $_SESSION['errors'] = $errors;
            $_SESSION['old_input'] = $_POST;
            $this->redirect("/Gestion-sena/dashboard_sena/instru_competencia/editar?id={$id}");
        }
