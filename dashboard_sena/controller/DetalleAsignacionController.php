...
class DetalleAsignacionController extends BaseController {
    ...
    public function store() {
        ...
        if (!empty($errors)) {
            ...
            $this->redirect('/Gestion-sena/dashboard_sena/detalle_asignacion/crear');
        }
        
        try {
            $this->model->create($_POST);
            $_SESSION['success'] = 'Detalle de asignación creado exitosamente';
            $this->redirect('/Gestion-sena/dashboard_sena/detalle_asignacion');
        } catch (Exception $e) {
    ...
    public function update($id) {
        ...
        if (!empty($errors)) {
            $_SESSION['errors'] = $errors;
            $_SESSION['old_input'] = $_POST;
            $this->redirect("/Gestion-sena/dashboard_sena/detalle_asignacion/editar?id={$id}");
        }
