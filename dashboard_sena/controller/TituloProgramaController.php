...
class TituloProgramaController extends BaseController {
    ...
    public function store() {
        ...
        if (!empty($errors)) {
            ...
            $this->redirect('/Gestion-sena/dashboard_sena/titulo_programa/crear');
        }
        
        try {
            $this->model->create($_POST);
            $_SESSION['success'] = 'Título creado exitosamente';
            $this->redirect('/Gestion-sena/dashboard_sena/titulo_programa');
        } catch (Exception $e) {
    ...
    public function update($id) {
        ...
        if (!empty($errors)) {
            $_SESSION['errors'] = $errors;
            $_SESSION['old_input'] = $_POST;
            $this->redirect('/Gestion-sena/dashboard_sena/titulo_programa/editar?id=' . $id);
        }
