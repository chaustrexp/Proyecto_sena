...
class SedeController extends BaseController {
    ...
    public function store() {
        if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
            $this->redirect('/Gestion-sena/dashboard_sena/sede');
            return;
        }
        ...
        if (!empty($errors)) {
            ...
            $this->redirect('/Gestion-sena/dashboard_sena/sede/crear');
            return;
        }
    ...
    public function update($id) {
        ...
        if (!empty($errors)) {
            $_SESSION['error'] = 'Por favor complete todos los campos requeridos';
            $this->redirect('/Gestion-sena/dashboard_sena/sede/editar/' . $id);
            return;
        }
