...
class ProgramaController extends BaseController {
    ...
    public function store() {
        if (!$this->isMethod('POST')) {
            $this->redirect('/Gestion-sena/dashboard_sena/programa/create');
            return;
        }
        
        // Validar campos requeridos
        $required = ['prog_denominacion', 'TIT_PROGRAMA_titpro_id'];
        $errors = [];
        ...
        try {
            ...
            if ($result) {
                ...
                $this->redirect('/Gestion-sena/dashboard_sena/programa');
            } else {
    ...
    public function update($id) {
        if (!$this->isMethod('POST')) {
            $this->redirect("/Gestion-sena/dashboard_sena/programa/edit/{$id}");
            return;
        }
