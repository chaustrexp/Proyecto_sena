...
function performSearch(query) {
    ...
    fetch(`/Gestion-sena/dashboard_sena/api/search.php?q=${encodeURIComponent(query)}`)
    ...
    return [
        {
            ...
            url: '/Gestion-sena/dashboard_sena/views/asignacion/ver.php?id=1',
            icon: 'calendar'
        },
        {
            title: 'Instructor: María García',
            subtitle: 'Especialidad: Programación',
            url: '/Gestion-sena/dashboard_sena/views/instructor/ver.php?id=1',
            icon: 'user'
        },
        {
            title: 'Ficha 2024-01',
            subtitle: 'Programa: Desarrollo de Software',
            url: '/Gestion-sena/dashboard_sena/views/ficha/ver.php?id=1',
            icon: 'file-text'
        }
    ];
}
